...
extension BarLineChartViewBase {
    ...
    func setBarLineChartViewBaseProps(_ config: String!) {
        ...
        if json["leftAxis"].exists() {
            ...
            if json["leftAxis"]["minWidth"].exists() {
              self.leftAxis.minWidth = CGFloat(json["leftAxis"]["minWidth"].floatValue);
            }
          
            if json["leftAxis"]["maxWidth"].exists() {
              self.leftAxis.maxWidth = CGFloat(json["leftAxis"]["maxWidth"].floatValue);
            }
